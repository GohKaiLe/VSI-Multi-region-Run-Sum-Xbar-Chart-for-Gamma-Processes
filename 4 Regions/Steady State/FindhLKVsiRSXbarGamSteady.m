% Create function to find hL and K %
% Steady State%

function [hL, K] = FindhLKVsiRSXbarGamSteady(AATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale)
    ...
    obj_fun = @(x) SteadyConstraints(x, AATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale) ; 
