...
function [hL, K] = EATSFindhLKVsiRSXbarGam(EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale)
    ...
    obj_fun = @(x) EATSConstraints(x, EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, a_shape, b_scale) ; 
