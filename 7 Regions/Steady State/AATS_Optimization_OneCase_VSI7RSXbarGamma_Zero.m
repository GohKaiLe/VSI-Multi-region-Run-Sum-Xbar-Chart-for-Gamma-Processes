...
hS = 0.1 ; % short sampling interval 
        ...
        for S3 = S2:4 
            for S4 = S3:6
                for S5 = S4:5
                    for S6 = S5: 8
                        for S7 = S6:10
                            [hL, K] = FindhLKVsiRSXbarGamSteady(AATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale); 
                            ...
                            if abs(AATS0 - AATS0_target) < 1 
                                AATS1 = AATSFindGam(n, K, delta, hS, hL, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
                                SDATS1 = SDATSFindGam(n, K, delta, hS, hL, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
                                out = [out; hS, hL, S1, S2, S3, S4, S5, S6, S7, K, AATS0, ASI0, AATS1, SDATS1] 
                                if AATS1 < AATS1min
                                SDATS1min = SDATS1 ; 
                                AATS1min = AATS1 ;
                                AATS0min = AATS0 ; 
