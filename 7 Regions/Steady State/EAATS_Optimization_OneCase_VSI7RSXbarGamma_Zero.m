% Optimal Parameters for VSI Two-sided 7 Regions RS for Gamma %
% Steady State % 
        ...
        for S3 = S2:4 
            for S4 = S3:6
                for S5 = S4:5
                    for S6 = S5: 8
                        for S7 = S6:10
                            [hL, K] = EAATSFindhLKVsiRSXbarGam(EAATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale); 
                            ...
                            if abs(EAATS0 - EAATS0_target) < 1 
                                EAATS = EAATSFindGam(n, K, deltamin, deltamax, hS, hL, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
                                out = [out; hS, hL, S1, S2, S3, S4, S5, S6, S7, K, EAATS0, ASI0, EAATS] 
                                if EAATS < EAATSmin
                                EAATSmin = EAATS ;
                                EAATS0min = EAATS0 ; 
                                ASI0min = ASI0 ; 
...
Final_results = [hS, Opt_hL, Opt_S1, Opt_S2, Opt_S3, Opt_S4, Opt_S5, Opt_S6, Opt_S7, Opt_K, EAATS0min, ASI0min, EAATSmin] 
