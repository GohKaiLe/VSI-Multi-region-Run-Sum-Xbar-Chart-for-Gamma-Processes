        ...
        for S3 = S2:4 
            for S4 = S3:6
                for S5 = S4:5
                    for S6 = S5: 8
                        for S7 = S6:10
                            [hL, K] = EATSFindhLKVsiRSXbarGam(EATS0_target, ASI0_target, n, hS, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale); 
                            ...
                            if abs(EATS0 - EATS0_target) < 1 
                                EATS = EATSFindGam(n, K, deltamin, deltamax, hS, hL, G, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
                                out = [out; hS, hL, S1, S2, S3, S4, S5, S6, S7, K, EATS0, ASI0, EATS] 
                                if EATS < EATSmin
                                EATSmin = EATS ;
                                EATS0min = EATS0 ; 
                                ASI0min = ASI0 ; 
...
Final_results = [hS, Opt_hL, Opt_S1, Opt_S2, Opt_S3, Opt_S4, Opt_S5, Opt_S6, Opt_S7, Opt_K, EATS0min, ASI0min, EATSmin] 
